...
const Projects = () => {
    const projects = [
        { id: 1, title: "WiseCursor Webpage", image: wiseCursorLogo, description: "Official webpage of WiseCursor. This is a React-based webpage built from high‑fidelity UI/UX designs, combining responsive components with pixel‑perfect execution of layouts in collaboration with Project Managers and UX design teams.", languages: ["React", "Tailwind CSS"], date: "Dec 2025 - In Progress", url: "https://www.wisecursor.com/waitlist" },
        { id: 2, title: "DFW Flight Companion", image: background, description: "Graduate Capstone Project developed for DFW Airport. This is a dedicated Android navigation tool that helps travelers locate and navigate the amenities within Terminal D at DFW Airport. It features a mock indoor map with the amenities, offers turn-by-turn navigation, and allows users to filter amenities to find the ones that best meet their desired needs.", languages: ["Kotlin", "Node.js", "Google Firebase"], date: "Jan 2026 - May 2026", url: "https://github.com/GamingSlayerNS/DFW-Flight-Companion.git" },
        { id: 3, title: "Boogle Search Engine", image: background, description: "A KWIC-based search engine that utilizes a Keyword‑in‑Context indexing system to deliver relevant search results.", languages: ["React", "Python", "Google Firebase"], date: "Aug 2025 - Dec 2025", url: "https://github.com/LeiNode/Boogle-Search-Engine.git" },
        { id: 4, title: "Flights Pocket Booking Platform", image: flightsPocketLogo, description: "An all‑in‑one travel booking platform for flights, hotels, rental cars, and cruises. It also features a booking‑lookup tool that allows admins to retrieve booking records from the SQL database using booking ID numbers.", languages: ["PHP", "SQL", "CSS"], date: "Aug 2025 - Dec 2025", url: "https://github.com/GamingSlayerNS/FlightsPocket.git" },
                    ...
                    {projects.map((p) => (
                        <SwiperSlide key={p.id} className="project-card">
                            ...
                            >
                                ...
                                <div className="project-lang-grid">
                                    {p.languages.map((lang) => (
                                        <div className="project-lang-box">{lang}</div>
                                    ))}
                                </div>
